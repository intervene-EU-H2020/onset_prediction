...
utils::globalVariables(c("SCORE", "SCORE_GROUP", "ID", "Group", "Age", "HR", "CI_NEG", "CI_POS", "Endpoint", "CCI_score", "predict", "GROUP", "ENDPOINT", "EXP_LEN", "EXP_END", "EXP_END_PERIOD", "EXP_AGE"))