...
utils::globalVariables(c("SCORE", "ID", "Group", "Age", "HR", "CI_NEG", "CI_POS", "Endpoint", "CCI", "predict", "GROUP", "ENDPOINT", "EXP_LEN", "EXP_END", "EXP_END_PERIOD", "EXP_AGE", "DATE_OF_BIRTH", "EXP_END_DATE"))