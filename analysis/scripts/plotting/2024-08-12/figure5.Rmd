...
meta_sub$Endpoint <- factor(meta_sub$Endpoint, levels=names(color_list))
...
# Correlation
```{r}
fg_cors <- get_data("/home/detrokir/Documents/DSGE/GitHub/onset_prediction/analysis/data/orig/finngen/fg_down_2024-05-29/fg/PheRS_PRS/2019-01-01_o8_w2_e10_32_70_cors.tsv", "FinnGen")

fg_cors_cciedu <- get_data("/home/detrokir/Documents/DSGE/GitHub/onset_prediction/analysis/data/orig/finngen/fg_down_2024-05-29/fg/EDU_CCI/2019-01-01_o8_w2_e10_32_70_cors.tsv", "FinnGen")

ukb_cors_prs <- get_data("/home/detrokir/Documents/DSGE/GitHub/onset_prediction/analysis/data/orig/ukbb/ukbb_down_2024-07-02/prs/2019-01-01_o8_w2_e10_32_70_cors.tsv", "UKB")
estb_cors <- get_data("/home/detrokir/Documents/DSGE/GitHub/onset_prediction/analysis/data/orig/estbb/estbb_down_2024-06-10/2019-01-01_o8_w2_e6_32_70_cors.tsv", "EstB")

ukb_cors <- get_data("/home/detrokir/Documents/DSGE/GitHub/onset_prediction/analysis/data/orig/ukbb/ukbb_down_2024-07-02/2019-01-01_o8_w2_e10_32_70_cors.tsv", "UKB")
...
plt_b <- ggplot(cors_long, aes(x=abs(COR), y=reorder(Final_name, ENDPT_ORDER), color=Biobank)) +
...
```{r}
top_plt <- cowplot::plot_grid(NULL, plt_a, NULL, plt_b, NULL, nrow=1, align="h", rel_widths=c(0.05, 0.4, -0.05, 0.4, 0.1))
top_plt
...
ggsave(paste0(plt_res_dir, "fig5_v4.pdf"), full_plt, width=22, height=10, dpi=600, unit="in", bg="white")
```
