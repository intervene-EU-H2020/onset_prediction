test_that("join_endpt_indvs_mats works", {
  ...
  endpt_mat <- join_endpt_indvs_mats(crnt_endpt, endpt="J10_ASTHMA", prev_endpt, set_nas_true=TRUE)
...
test_that("join_endpt_indvs_mats works", {
  crnt_endpt <- tibble::tibble(ID=c("1","3","4","6","7","8"),
                               J10_ASTHMA_crnt=c(1,1,0,1,0,1))
  endpt_mat <- join_endpt_indvs_mats(crnt_endpt, endpt="J10_ASTHMA", set_nas_true=TRUE)
