...
```{r}
common_path <- "/home/kira/duni/helsinki/DSGE/results/forestplots/HR/2019-01-01_o8_w2_e10_PRS_CCI_fp"
save_forestplotter(paste0(common_path, "_striped.png"), g)
save_forestplotter(paste0(common_path, "_marked_good.png"), plt_marked_good)
