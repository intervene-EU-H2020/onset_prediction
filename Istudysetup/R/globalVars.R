...
utils::globalVariables(c("DATE_OF_BIRTH", "DATE_EXP", "AGE_AT_DIAG", "ID", "FOLLOWUP", "SEX", "START_OF_FOLLOWUP", "END_OF_FOLLOWUP", "ANCESTRY", "ENDPT_FREE", "STUDY_TIME", "AGE_AT_ONSET"))